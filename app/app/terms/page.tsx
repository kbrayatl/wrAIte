    ...
    <div className="min-h-screen bg-[var(--color-bg)]">
      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        ...
        <div className="prose prose-invert max-w-none space-y-6 text-[var(--color-text-secondary)]">
          ...
          <p>
            By using OutreachAI, you agree to these terms. If you don't agree, please don't use our service.
          </p>
          
          <h2 className="text-xl font-semibold text-[var(--color-text)] mt-8 mb-4">
            What OutreachAI Does
          </h2>
          <p>
            OutreachAI is an AI-powered tool that helps you generate outreach messages. We provide suggestions based on your inputs. You are responsible for reviewing and customizing any content before sending it.
          </p>
          ...
          <p>
            You agree to use OutreachAI only for lawful purposes. You will not use our service to:
          </p>
          ...
          <p>
            OutreachAI is provided "as is." We don't guarantee that our suggestions will be effective, appropriate, or error-free. Always review generated content before use.
          </p>
